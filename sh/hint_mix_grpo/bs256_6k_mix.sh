...
# [DEL] Hard-coded `xxx` placeholders made this migration entry point unusable.
# PROJECT_NAME='xxx'; EXP_NAME='xxx'; MODEL_PATH=xxx
# [ADD] Require concrete experiment/model values from the caller.
...
# [DEL] data_train_path=xxx
# [ADD] Require an explicit parquet path for this generic template.
data_train_path="${DATA_TRAIN_PATH:?Set DATA_TRAIN_PATH to the training parquet}"
...
# ------------------------------------------------------------------------
# [DEL] python3 -m hint_mix_grpo.main_ppo
# [DEL] The migrated verl 0.7 launch command was accidentally commented out.
# [DEL] Removed unsupported `trainer.hint_data_dir` from this generic entry point.
# [ADD] Launch the native verl 0.7 trainer.
