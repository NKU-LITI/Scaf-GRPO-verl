...
# [ADD] 读取专家轨迹
def _normalize_scaf_expert_target(row_dict: dict):
    ...
    for key in ("solution_breakdown_cot_answer",): 
        ...
        if expert_target:
            row_dict["expert_target"] = expert_target
            return
...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # [ADD] Normalize old Scaf parquet schemas before the row is placed in the DataProto.
        _normalize_scaf_expert_target(row_dict)
