...
class ActorConfig(BaseConfig):
    ...
    # [ADD] Scaf-GRPO: enable auxiliary SFT/NLL loss on successful hinted rollout trajectories.
    use_hint_sft_loss: bool = False
    # [ADD] Scaf-GRPO: auxiliary SFT/NLL loss weight for successful hinted rollout trajectories.
