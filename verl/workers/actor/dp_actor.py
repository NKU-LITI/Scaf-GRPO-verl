        ...
        for _ in range(self.config.ppo_epochs):
            for batch_idx, mini_batch in enumerate(mini_batches):
                ...
                for micro_batch in micro_batches:
                    ...
                    sft_loss_mask = model_inputs.get("sft_loss_mask")
                    hint_sft_loss_mask = model_inputs.get("hint_sft_loss_mask")
                    off_policy_mask = model_inputs.get("off_policy_mask")
                    ...
                    # [ADD] Compute PPO/off-policy RL and auxiliary SFT in one shared objective used by both legacy actor backends.
